...
public class NotificationController {
    ...
    @PostMapping
    public ResponseEntity<Void> sendNotification(@RequestBody @NotNull NotificationRequest request) {
    ...
    public ResponseEntity<Void> sendDirectEmail(@RequestBody @NotNull DirectEmailRequest request) {
